...
const BonusLedgerView = ({ clientId }) => {
  ...
  useEffect(() => {
    ...
    const fetchLedgerData = async () => {
      try {
        const response = await fetch(`http://localhost:80/api/getbonusledger/${clientId}`);
...
export default BonusLedgerView;
